...
{  
 ...
 private void drawStructure(Graphics g) {  
  ...
  g.drawString("bat cave pro", 135, 150); 
  
  g.setFont(new Font("TimesRoman", Font.BOLD, 30));  
  g.setColor(Color.red);  
  g.drawString("9", xcenter - 140, ycenter + 10);  
  g.drawString("3", xcenter + 125, ycenter + 10);  
  g.drawString("12", xcenter - 10, ycenter - 120);  
  g.drawString("6", xcenter - 10, ycenter + 145);  
 }  
/*
 * Paint a java.awt.Graphics g
 * 
 */
 ...
 {  
  ...
  g.drawString(hour+":"+minute, 135, 350); 
 ...
 /*
  * Start method call this after constructor
  */
 public void start()   
 {  
  if (thread == null)   
 ...
 /*
  * Stop it by setting the flag thread to null; 
  * what happens to the running thread ??
  */
 public void stop()   
 {  
  thread = null;  
